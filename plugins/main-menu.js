...
//  let tags
 //  let teks = `${args[0]}`.toLowerCase()
  ...
  const ftrol = {
      ...
      //------------------< MENU All>----------------
let all = `
Hallo kak ${name}, ${ucapan()}, Saya adalah WhatsApp Bot yang dilengkapi dengan fitur keren seperti unduhan tiktok, membuat stiker, mencari lagu, dan banyak lagi saya di sini untuk membantu Anda, dalam berbagai cara, termasuk pengiriman, dan dll. Fitur yang tersedia ada di bawah ini
